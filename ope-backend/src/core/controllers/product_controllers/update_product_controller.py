class UpdateProductController:
    ...
    def route(self, body):
        ...
        if body is not None:
            ...
            response = self.update_product_use_case.update(product_id=product_id, name=name, description=description, price=price, amount=amount, promotion=promotion, img=img)
            return response
